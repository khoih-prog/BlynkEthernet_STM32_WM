...
#ifndef BlynkSTM32EthernetENC_WM_h
#define BlynkSTM32EthernetENC_WM_h
  ...
  #define BLYNK_ETHERNET_STM32_WM_VERSION     "BlynkEthernet_STM32_WM v1.1.1"
#endif
